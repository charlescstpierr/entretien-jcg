...
const service = services.find((s) => s.slug === "deneigement")!;
const faqCategory = faqCategories.find((c) => c.slug === "deneigement");
const faqItems = faqCategory?.items ?? [];

export const metadata = createMetadata({
  title: service.metaTitle,
  description: service.metaDescription,
  path: "/services/deneigement",
});

const DeneigementPage = () => {
  return (
    <>
...
export default DeneigementPage;
