...
const service = services.find((s) => s.slug === "amenagement-paysager")!;
const faqCategory = faqCategories.find((c) => c.slug === "amenagement-paysager");
const faqItems = faqCategory?.items ?? [];

export const metadata = createMetadata({
  title: service.metaTitle,
  description: service.metaDescription,
  path: "/services/amenagement-paysager",
});

const AmenagementPaysagerPage = () => {
  return (
    <>
...
export default AmenagementPaysagerPage;
